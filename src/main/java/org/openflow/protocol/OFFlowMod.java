...
public class OFFlowMod extends OFMessage implements OFActionFactoryAware, Cloneable {
    ...
    // Commands
    public static final short OFPFC_ADD = 0;                /* 增加一个新的流表项. */
    public static final short OFPFC_MODIFY = 1;             /* 修改所有匹配的流表项. */
    public static final short OFPFC_MODIFY_STRICT = 2;      /* 修改严格匹配的流表项 */
    public static final short OFPFC_DELETE=3;               /* 删除所有匹配的流表项. */
    public static final short OFPFC_DELETE_STRICT =4;       /* 删除严格匹配的流表项. */

    // Flags
    public static final short OFPFF_SEND_FLOW_REM = 1;/*发送删除消息当流过期或被删除.*/
    public static final short OFPFF_CHECK_OVERLAP = 2;/*首先要看的是重叠的表项.*/
    public static final short OFPFF_EMERG         = 4;/*重置流数据包和字节计数.*/
    public static final short OFPFF_NO_PKT_COUNTS = 8;/*不要监测的数据包计数.*/
    public static final short OFPFF_NO_BYT_COUNTS = 16;/*不要监测的字节计数.*/

    protected OFActionFactory actionFactory;
    protected OFMatch match;
    protected long cookie;
    protected short command;
    protected short idleTimeout;/*丢弃之前的空闲时间(seconds).*/
    protected short hardTimeout;/*丢弃之前的最大时间(seconds).*/
